...
หากละเว้น `--name` หรือ `--room` โปรแกรมจะถามเมื่อเริ่มต้น ชื่อของผู้เข้าร่วมแต่ละคนต้องไม่ซ้ำกันภายในห้องและต้องไม่มี `/` — หากชื่อถูกใช้แล้วหรือไม่ถูกต้อง ฮับจะปฏิเสธการเชื่อมต่อ
...
5. **ช่องชื่อ:**
   - **โหมดผู้แสดง** (scsynth ทำงานอยู่แล้ว): ป้อนชื่อของคุณ ต้องไม่ซ้ำในห้องและต้องไม่มี `/`
...
ฮับตอบกลับด้วยข้อความ OSC `/who/reply` ที่มีชื่อของผู้เข้าร่วมปัจจุบันทั้งหมดเป็นอาร์กิวเมนต์ string:
