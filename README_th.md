...
หากละเว้น `--name` หรือ `--room` โปรแกรมจะถามเมื่อเริ่มต้น ชื่อของผู้เข้าร่วมแต่ละคนต้องไม่ซ้ำกันภายในห้อง ต้องไม่ว่างเปล่า ต้องไม่เกิน 64 ตัวอักษร และต้องไม่มี `/` — หากชื่อถูกใช้แล้วหรือไม่ถูกต้อง ฮับจะปฏิเสธการเชื่อมต่อ ชื่อห้องก็ต้องไม่ว่างเปล่าเช่นกัน
