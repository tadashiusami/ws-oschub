...
Kung aalisin ang `--name` o `--room`, tatanungin ka ng programa sa startup. Ang pangalan ng bawat kalahok ay dapat natatangi sa loob ng silid at hindi dapat naglalaman ng `/` — kung ang pangalan ay ginagamit na o hindi wasto, ang hub ay tatanggihan ang koneksyon.
...
5. **Field ng pangalan:**
   - **Performer mode** (tumatakbo na ang scsynth): ilagay ang iyong pangalan. Dapat natatangi sa silid at hindi naglalaman ng `/`.
